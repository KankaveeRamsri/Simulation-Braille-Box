...
export default function Pin({ active }: PinProps) {
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      {active && (
        <div className="absolute h-4 w-4 rounded-full bg-[#39ff8f] opacity-40 blur-[7px]" />
      )}
      <div
        className={[
          "relative h-3.5 w-3.5 rounded-full transition-all duration-150 ease-out",
          active
            ? "translate-y-0 scale-100 bg-[#7fffb2] shadow-[0_0_9px_2px_rgba(57,255,143,0.85)]"
